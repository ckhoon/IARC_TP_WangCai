...
//static int16_t of_alt_climbrate = 0;
////////////////////////////////////////////////////////////////////////////////
// GCS selection
////////////////////////////////////////////////////////////////////////////////
...
static void update_optical_flow(void)
{
    ...
    static uint8_t of_update_counter = 0;
    //static float TOT_X = 0, TOT_Y = 0;
    //program called at 100hz but updating the of_reading at 20hz
    of_update_counter+=1;
    //if( of_update_counter == 1 ) {
    //  of_y_cm = (raw_of_y_cm);
    //  of_x_cm = (raw_of_x_cm);
    //}
    if( of_update_counter > 1 ) {//program called at 100hz but updating the of_reading at 50hz
        of_update_counter = 0;
        of_y_cm = ((raw_of_y_cm)*of_time_interval);
        ...
        //TOT_Y += of_y_cm;
        //hal.console->printf(("\nTOT_X: %f"), TOT_X);
        //hal.console->printf((":: TOT_Y: %f"), TOT_Y);
        //logging
        //if( of_log_counter++ >= 4 ) {
        //    of_log_counter = 0;
...
static void update_GPS(void)
{
    ...
    //g_gps->update();//commented to avoid the gps
        ...
        if(ap.auto_armed) {
            ...
            if (ap.land_complete) {
                if (pilot_climb_rate > 0) {
                	...
                	//END - modified to enable auto take off
                }
            }
...
static void update_altitude()
{
    ...
    //This update is at slow because the variable "current_loc.alt" that controls alt_hold takes in reading from Optical_flow sonar at 100hz.
    // read in sonar altitude
    if((avg_of_alt*100)<300){
    sonar_alt           = current_loc.alt;}//(avg_of_alt*100);}  current_loc.alt gets reading from Optical flow sonar and it will take reading from baro if there is not Optical flow update
