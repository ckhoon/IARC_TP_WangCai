...
static void NOINLINE send_OF_message(mavlink_channel_t chan){  // send OF message to GCS
    mavlink_msg_optical_flow_send(
        chan,                            //channel
        raw_flow_read.time_usec,         // time
        raw_flow_read.sensor_id,         // sensor_id
        raw_flow_read.flow_x,            // flow_x
        raw_flow_read.flow_y,            // flow_y
        tot_x_cm,//                      // tot displacement in x from the time OF_loiter mode is entered
        tot_y_cm,//                      // tot displacement in y from the time OF_LOITER mode is entered
        raw_flow_read.quality,           // quality
        raw_flow_read.ground_distance);  // ground_distance
}
